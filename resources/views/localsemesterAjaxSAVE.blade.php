		...
		$(document).ready(function(e){
			$.ajax({
				...
				Array.from(data).forEach((value)=>{
					...
					ls_box.innerHTML = '<div>작성자 : "'+value.user.name+'"</div>\<div>제목 : "'+value.title+'"</div>\<div class="ls-image" name="'+value.id+'" value="'+value.id+'">ls-image</div>\<button class="button-update" name="'+value.id+'">수정</button>\<button class="button-delete" name="'+value.id+'">삭제</button>';
